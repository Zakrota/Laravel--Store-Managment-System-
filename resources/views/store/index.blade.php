...
<div class="row">
    <div class="col-sm-8">
        <form method="get" class="row DTForm" action="/store">
            <div class="col-sm-5">
                <input name="q" type="text" class="form-control" placeholder="بحث عن مخزن...">
            </div>
    ...
    <div class="col-sm-4 text-right">
        <a href="/store/create" title="انشاء مخزن جديد" class="btn Popup btn-success"><i class="glyphicon glyphicon-plus"></i> اضافة مخزن جديد</a>
    </div>
</div>
<hr>
        ...
        function BindDataTable() {
           oTable = $('#tblAjax').dataTable(
           {
               ...
               columns: [                       
                       ...
                       {
                           name: 'buttons', "render": function (data, type, row) {
                               return "<a title='تعديل مخزن' href='/store/" + row["id"] + "/edit' class='btn btn-primary Popup btnEdit btn-xs'><i class='glyphicon glyphicon-edit'></i></a> "                              
                               + " <a href='/store/" + row["id"] + "/delete' class='btn ConfirmLink btn-danger btn-xs'><i class='glyphicon glyphicon-trash'></i></a>";
                           }
                       }
               ],
               ajax: {
